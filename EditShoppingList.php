...
//
                                     ...
                                     '</div>'.
                                        ...
                                        '<div class="col-md-3">'.
                                            '<select class="form-control pull-right" name="'. $get_list['ProductID'].'">'.
                                                '<option value="Filter By Country" selected disabled>Delete by Quantity</option>'.
                                                    '<ol class="breadcrumb">';
                                                        $count = 1;
                                                        while( $count < $get_list['UnitsInCart']) {
                                                            echo '<option value="'. $count.', '. $get_list['ProductID'].'">'. $count.'</option>';
                                                            $count++;
                                                        }
            ...
            ?>
                <input type="submit" class="btn btn-block btn-warning" name="CustomEdit">
                </form>
